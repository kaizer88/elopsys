...
class Migration(migrations.Migration):
	def insert_permissions(apps, schema_editor):
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_stcomment').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_stdocument').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_stockitem').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_stockreplenishment').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_stocktake').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_strequisition').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_strequisitionitem').pk)
		...
		ops_assets.permissions.add(Permission.objects.get(codename='edit_branchstock').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_stcomment').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_stdocument').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_stockitem').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_stockreplenishment').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_stocktake').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_strequisition').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_strequisitionitem').pk)
		...
		ops_stock.permissions.add(Permission.objects.get(codename='edit_branchstock').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_stcomment').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_stdocument').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_stockitem').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_stockreplenishment').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_stocktake').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_strequisition').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_strequisitionitem').pk)
		...
		ops_assistant.permissions.add(Permission.objects.get(codename='edit_branchstock').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_stcomment').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_stdocument').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_stockitem').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_stockreplenishment').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_stocktake').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_strequisition').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_strequisitionitem').pk)
		...
		ops_offices.permissions.add(Permission.objects.get(codename='edit_branchstock').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_stcomment').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_stdocument').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_stockitem').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_stockreplenishment').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_stocktake').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_strequisition').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_strequisitionitem').pk)
		...
		ops_property.permissions.add(Permission.objects.get(codename='edit_branchstock').pk)

	dependencies = [
		('accounts', '0004_auto_20170516_1100'),
	]
